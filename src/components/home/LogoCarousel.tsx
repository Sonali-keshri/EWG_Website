...
export function LogoCarousel() {
  return (
    <div className="ewg-bleed ewg-card-frame pt-10 pb-8 lg:pt-28 lg:pb-16">
      <div className="ewg-card-inset group overflow-hidden bg-black/50 py-4 lg:rounded-[1.75rem] lg:py-12">
