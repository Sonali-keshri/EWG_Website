...
export function Button({
  ...
  return (
    <Link
      ...
      className={cn(
        "group inline-flex h-10 items-center justify-center gap-2.5 rounded-full border px-6 font-sans text-[0.95rem] font-medium tracking-normal transition-colors duration-300",
        isActive
